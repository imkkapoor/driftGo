...
func (s *Service) ExchangePublicToken(ctx context.Context, exchangePublicTokenRequest ExchangePublicTokenCallRequest) (*AccessTokenCallResponse, error) {
	request := plaid.NewItemPublicTokenExchangeRequest(exchangePublicTokenRequest.PublicToken)
